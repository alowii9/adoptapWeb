    ...
    <div>
        ...
        <div style={navStyle}>
            <ul style={ulStyle}>
                        ...
                        <li style={liStyle}>
                        <Link legacyBehavior href="/principal/mascotasEnAdopcion">
                            <a style={aStyle}>Mascotas en adopcion</a>
                        </Link>
                        </li>

                        <li style={liStyle}>
                        <Link legacyBehavior href="/principal/mascotasPerdidas">
                            <a style={aStyle}>Mascotas Perdidas</a>
                        </Link>
                        </li>

                        <li style={liStyle} >
                        <Link legacyBehavior href="/principal/locales">
                            <a style={aStyle}>Locales</a>
                        </Link>
                        </li>

                        <li style={liStyle} >
                        <Link legacyBehavior href="/principal/donaciones">
                            <a style={aStyle}>Donaciones</a>
                        </Link>
                        </li>
          ...
          {isLoggedIn ? (
            ...
            <Link legacyBehavior href="/login">
              <a style={aStyle}>Iniciar sesión</a>
            </Link>
          )}
        </div>
      </div>
